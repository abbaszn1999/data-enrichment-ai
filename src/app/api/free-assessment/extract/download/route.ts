...
import { loadExtractRowsAdmin } from "@/lib/free-assessment/storage-admin";
import type { KeywordRow } from "@/lib/free-assessment/providers/keyword-provider";
...
export async function GET(request: NextRequest) {
  ...
  const auth = await requireFaRead(parsed.data.workspaceId);
  ...
  try {
    ...
    console.error("[api/free-assessment/extract/download] Error:", err);
