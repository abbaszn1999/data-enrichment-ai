 ...
 *  persistent setting below. Free Assessment defaults to no floor (0). */
...
type StageSelectPanelProps = {
   ...
   * a persistent per-project setting. Falls back to local state when no
   * `onChangeSkuFloor` is given (e.g. mock/demo usage).
   */
  skuFloor?: number;
      ...
      <div className="flex-1 min-h-0 space-y-4 overflow-y-auto pb-4">
        <div className="space-y-2">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {/* Persistent per-project setting — minimum SKUs a
