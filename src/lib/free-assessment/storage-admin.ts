...
export async function loadSameIntentState(
  ...
  return loadFaJsonAdmin<SameIntentState>(
    admin,
...
export async function loadSameIntentSurvivors(
  ...
  return (
    (await loadFaJsonAdmin<SameIntentSurvivorRecord[]>(
      admin,
...
export async function loadSameIntentLeaders(
  ...
  return (
    (await loadFaJsonAdmin<SameIntentLeaderRecord[]>(
      admin,
...
export async function loadSameIntentAssignments(
  ...
  return (
    (await loadFaJsonAdmin<Record<string, string>>(
      admin,
...
export async function loadSameIntentClusters(
  ...
  return (
    (await loadFaJsonAdmin<SameIntentClusterRecord[]>(
      admin,
