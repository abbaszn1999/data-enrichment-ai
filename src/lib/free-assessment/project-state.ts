...
import type { Stage1ChatMessage } from "@/components/free-assessment/agent-panel";
import {
...
export type FaProjectStateJson = {
  stage1Done?: boolean;
...
function projectFromRow(row: FaProjectRow): MarketResearchProject {
...
function stateFromRow(row: FaProjectRow): FaProjectStateJson {
